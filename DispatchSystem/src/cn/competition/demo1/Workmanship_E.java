...
public class Workmanship_E extends GeneticAlgorithm_B{
    public static void main(String[] args) {
        Workmanship_E workmanship_e=new Workmanship_E();
        workmanship_e.setTranslateMode(3);
        workmanship_e.setGenes(ordering_BmachineToGene(3,new ArrayList<>(Arrays.asList(
                //9560.6
        ...
        workmanship_e.setPopSize(100);//设置种群数量
        workmanship_e.setGeneSize(300);//设置基因最大长度
        workmanship_e.setMaxIterNum(500);//设置最大迭代次数
        workmanship_e.setMutationRate(0.3);//设置基因变异的概率
        workmanship_e.setMaxMutationNum(180);//设置最大变异步长
        workmanship_e.setMaxNum(150000);//将最小值转变为最大值求解
        workmanship_e.caculte();
    }
