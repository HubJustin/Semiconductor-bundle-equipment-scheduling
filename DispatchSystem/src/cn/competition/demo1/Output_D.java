...
public class Output_D {
    public static void main(String[] args) throws IOException {
        ...
        List<Ordering_Bmachine> orderingBmachines_init = new ArrayList<>(Arrays.asList(
                //9794.4
                new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB"),new Ordering_Bmachine("LLA", "PM7", "PM9", "LLB"),new Ordering_Bmachine("LLB", "PM8", "PM10", "LLB")
        ));
        int[] delayTime=new int[75];
        delayTime= new int[]{0, 728, 466, 922, 466, 833, 690, 725, 690, 725, 690, 725, 690, 725, 690, 3483, 896, 451, 952, 451, 856, 384, 941, 384, 941, 394, 941, 394, 941, 394, 3305, 1286, 466, 956, 466, 843, 690, 735, 690, 735, 690, 735, 690, 735, 690, 3493, 896, 461, 962, 461, 856, 404, 951, 404, 951, 404, 961, 404, 961, 404, 3325, 1296, 466, 976, 466, 853, 690, 745, 690, 745, 690, 745, 690, 745, 690};
//        int[] delayTime=new Output_D().optimizeWaitingTime(distanceTable,orderingBmachines_init);
...
//                    break;
            if (orderingBmachines_init.indexOf(orderingBmachine) < 25)
                machineList = new Output_D().LP1(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList, distanceTable, machineList, cleanMachineList, cleaningList, orderingBmachines_init.indexOf(orderingBmachine),delayTime);
            else if (orderingBmachines_init.indexOf(orderingBmachine) < 50)
                machineList = new Output_D().LP2(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList, distanceTable, machineList, cleanMachineList, cleaningList, orderingBmachines_init.indexOf(orderingBmachine),delayTime);
            else
                machineList = new Output_D().LP3(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList, distanceTable, machineList, cleanMachineList, cleaningList, orderingBmachines_init.indexOf(orderingBmachine),delayTime);
        }
        System.out.println(new Date());
        ...
        System.out.println("请输入您要写入的文件位置（不包含空格）");//C:\Users\Justin\Desktop\晶圆在PM上的停留时间_问题二D工艺.xlsx
        String path1 = sc.next();
        //writeStayTime
        writeStayTime(10,machineList,path1);
        System.out.println("写入成功！");
        System.out.println("请输入您要写入的文件位置（不包含空格）");//C:\Users\Justin\Desktop\工艺D单位时间最优产能.xlsx
        String path = sc.next();
        int wafer = 75;
    ...
    public int[] optimizeWaitingTime(List<Distance> distanceTable,List<Ordering_Bmachine> orderingBmachines){
        ...
        for (Ordering_Bmachine orderingBmachine : orderingBmachines) {
            if (orderingBmachines.indexOf(orderingBmachine) < 25)
                machineList_init = new Output_D().LP1(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList_init, distanceTable, machineList_init, cleanMachineList_init, cleaningList_init,orderingBmachines.indexOf(orderingBmachine),delayTime);
            else if (orderingBmachines.indexOf(orderingBmachine) < 50)
                machineList_init = new Output_D().LP2(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList_init, distanceTable, machineList_init, cleanMachineList_init, cleaningList_init,orderingBmachines.indexOf(orderingBmachine),delayTime);
            else
                machineList_init = new Output_D().LP3(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList_init, distanceTable, machineList_init, cleanMachineList_init, cleaningList_init,orderingBmachines.indexOf(orderingBmachine),delayTime);
        }
        ...
        for (int positionIndex = 1; positionIndex < 75; positionIndex++) {
            ...
            for (int i = delayTime[positionIndex]; i < 10000; i++) {
                ...
                for (Ordering_Bmachine orderingBmachine : orderingBmachines) {
                    if (orderingBmachines.indexOf(orderingBmachine) < 25)
                        machineList = new Output_D().LP1(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList, distanceTable, machineList, cleanMachineList, cleaningList,orderingBmachines.indexOf(orderingBmachine),delayTime);
                    else if (orderingBmachines.indexOf(orderingBmachine) < 50)
                        machineList = new Output_D().LP2(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList, distanceTable, machineList, cleanMachineList, cleaningList,orderingBmachines.indexOf(orderingBmachine),delayTime);
                    else
                        machineList = new Output_D().LP3(orderingBmachine.getFinalPosition0(), orderingBmachine.getFinalPosition1(), orderingBmachine.getFinalPosition2(), orderingBmachine.getFinalPosition3(), procedureList, distanceTable, machineList, cleanMachineList, cleaningList,orderingBmachines.indexOf(orderingBmachine),delayTime);
                }
