...
public class Workmanship_D extends GeneticAlgorithm_B{
    public static void main(String[] args) {
        Workmanship_D workmanship_d=new Workmanship_D();
        workmanship_d.setTranslateMode(2);
        workmanship_d.setGenes(ordering_BmachineToGene(2,new ArrayList<>(Arrays.asList(
                //9794.4
        ...
        workmanship_d.setPopSize(100);//设置种群数量
        workmanship_d.setGeneSize(300);//设置基因最大长度
        workmanship_d.setMaxIterNum(500);//设置最大迭代次数
        workmanship_d.setMutationRate(0.3);//设置基因变异的概率
        workmanship_d.setMaxMutationNum(180);//设置最大变异步长
        workmanship_d.setMaxNum(150000);//将最小值转变为最大值求解
        workmanship_d.caculte();
    }
